...
MySQL - 10.1.13-MariaDB : Database - basededatosparaatenderpedidodecompra
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`basededatosparaatenderpedidodecompra` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `basededatosparaatenderpedidodecompra`;
...
insert  into `articulo`(`OIDArticulo`,`codigoArticulo`,`nombreArticulo`,`stockArticulo`,`OIDTipoProducto`,`OIDMarca`) values ('1','1','Lavandina GEL 500 cc',30,'1','1'),('2','2','Lavandina Lavanda 500 cc',185,'2','2'),('3','3','Detergente Limón 1000 cc',210,'3','3'),('4','4','Detergente Aloe Vera 1000 cc',330,'1','1');
...
insert  into `estadoreposicion`(`OIDEstadoReposicion`,`codigoEstadoReposicion`,`nombreEstadoReposicion`) values ('1',1,'Calculada'),('2',2,'Pendiente a Cotizar'),('3',3,'Notificada'),('4',4,'Atendida'),('5',5,'Atendida Pendiente de Recepcion'),('6',6,'Finalizada');
...
insert  into `pedidodetalle`(`OIDPedidoDetalle`,`renglonPedido`,`OIDPedido`,`OIDArticulo`,`OIDCotizacionDetalle`,`cantidadPedido`) values ('1',1,'1','2','1',20),('2',2,'1','3','2',25),('3',3,'2','1','3',30),('4',4,'1','4','4',35);
...
insert  into `pedidoestado`(`OIDPedidoEstado`,`OIDPedido`,`OIDEstadoPedido`,`fechaDesdePedidoEstado`,`fechaHastaPedidoEstado`) values ('1','1','3','2016-04-03','2016-10-29'),('2','1','3','2016-04-13','2016-04-20'),('3','1','1','2016-04-23','2016-10-26'),('4','1','1','2016-04-30','2016-05-05'),('6018f88b-be7b-4b0b-8e50-aa4d37f852a1','1','2','2016-10-29',NULL);
...
insert  into `reposicion`(`OIDReposicion`,`numReposicion`,`fechaReposicion`,`OIDEstadoReposicion`) values ('1',1,'2016-03-02','5'),('2',2,'2016-03-03','4'),('3',3,'2016-03-03','4'),('4',4,'2016-03-04','4');
