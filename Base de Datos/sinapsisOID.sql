...
insert  into `articulo`(`OIDArticulo`,`codigoArticulo`,`nombreArticulo`,`stockArticulo`,`OIDTipoProducto`,`OIDMarca`) values ('1','1','Lavandina Ayudín GEL 500 cc',30,'1','1'),('2','2','Lavandina Ayudín Lavanda 500 cc',25,'2','2'),('3','3','Detergente Magistral Limón 1000 cc',10,'3','3'),('4','4','Detergente Magistral Aloe 1000 cc',50,'1','1'),('5','5','Lavanda',20,'3','2'),('6','6','lavanda2',32,'2','3');
...
insert  into `cotizaciondetalle`(`OIDCotizacionDetalle`,`OIDEstadoCotizacionDetalle`,`OIDCotizacion`,`OIDArticuloProveedor`,`OIDReposicionDetalle`,`renglonCotizacion`,`cantidadAPedirCotizacion`,`cantidadCotizada`,`precioArticuloLista`,`precioCotizacion`) values ('1','2','3','1','1',1,120,100,20,20),('2','2','2','1','2',2,555,555,22,19),('3','2','2','2','3',3,666,666,25,18),('4','1','1','2','4',4,70,60,25,13);
...
insert  into `parametro`(`codigoParametro`,`descripcionParametro`,`valorParametro`) values ('1','SistemaVentas','Tango'),('2','SistemaVentas','Sion7'),('3','ProtocoloMail','SMTP'),('4','ProtocoloMail','MAPI');
...
insert  into `pedidoestado`(`OIDPedidoEstado`,`OIDPedido`,`OIDEstadoPedido`,`fechaDesdePedidoEstado`,`fechaHastaPedidoEstado`) values ('1','1','1','2016-04-03',NULL),('2','1','1','2016-04-13','2016-04-20'),('3','1','1','2016-04-23','2016-04-30'),('4','1','1','2016-04-30','2016-05-05');
...
insert  into `proveedor`(`OIDProveedor`,`codigoProveedor`,`nombreProveedor`,`cuitProveedor`,`emailProveedor`,`estadoProveedor`,`OIDSistemaProveedor`) values ('1','A1','ProveedorA',2147483647,'proveedorA@gmail.com',1,'1'),('2','A2','ProveedorB',2147483647,'proveedorB@gmail.com',1,'1'),('3','A3','ProveedorC',2147483647,'proveedorC@gmail.com',0,'1'),('4','A4','ProveedorD',2147483647,'porveedorD@gmail.com',1,'2');
...
insert  into `reposicion`(`OIDReposicion`,`numReposicion`,`fechaReposicion`,`OIDEstadoReposicion`) values ('1',1,'2016-03-02','1'),('2',2,'2016-03-03','1'),('3',3,'2016-03-03','3'),('4',4,'2016-03-04','4');
...
insert  into `reposiciondetalle`(`OIDReposicionDetalle`,`OIDReposicion`,`OIDArticulo`,`renglonReposicion`,`cantidadAReponer`) values ('1','1','1',1,25),('2','1','2',2,50),('3','1','3',3,55),('4','1','4',4,20),('5','2','5',5,34),('6','2','2',6,333);
...
insert  into `sistemaproveedor`(`OIDSistemaProveedor`,`nombreSistemaProveedor`) values ('1','Tango'),('2','Sion7');
...
insert  into `tipoproducto`(`OIDTipoProducto`,`codigoTipo`,`nombreTipo`,`toxico`) values ('1','1','Lampazo','true'),('2','2','Balde','false'),('3','3','Brillapiso','true');
