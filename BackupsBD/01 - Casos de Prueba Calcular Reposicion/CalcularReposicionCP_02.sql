...
CREATE TABLE `articulo` (
  ...
  `codigoArticulo` varchar(40) DEFAULT NULL,
  `nombreArticulo` varchar(45) DEFAULT NULL,
  `stockArticulo` int(20) DEFAULT NULL,
...
INSERT INTO `articuloproveedor` VALUES ('1','B-0456',NULL,'1'),('2','R-0483',NULL,'2'),('3','R-0443',NULL,'2'),('4','R-002',NULL,'4');
...
INSERT INTO `cotizaciondetalle` VALUES ('1','2','3','1','1',1,120,100,20,20),('2','2','2','1','2',2,555,555,22,19),('3','2','2','2','3',3,666,666,25,18),('4','1','1','2','4',4,70,60,25,13);
...
INSERT INTO `listapreciodetalle` VALUES ('1',NULL,'1',30,1),('2',NULL,'2',25,2),('3',NULL,'3',43,3),('4',NULL,'4',20,4);
...
INSERT INTO `pedidodetalle` VALUES ('1',1,'1',NULL,'1',20),('2',2,'2',NULL,'2',25),('3',3,'1',NULL,'3',30),('4',4,'1',NULL,'4',35);
...
INSERT INTO `reposicion` VALUES ('1',1,'2016-03-02','2'),('2',2,'2016-03-03','3'),('3',3,'2016-03-03','3'),('4',4,'2016-03-04','4');
...
CREATE TABLE `reposiciondetalle` (
  ...
  `OIDArticulo` varchar(40) DEFAULT NULL,
  `renglonReposicion` int(20) DEFAULT NULL,
  `cantidadAReponer` int(20) DEFAULT NULL,
...
INSERT INTO `reposiciondetalle` VALUES ('1','1',NULL,1,25),('2','1',NULL,2,50),('3','1',NULL,3,55),('4','1',NULL,4,20),('5','2',NULL,5,34),('6','2',NULL,6,333);
...
-- Dump completed on 2016-11-14 14:53:52
