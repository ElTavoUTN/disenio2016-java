...
public class RecepcionarCotizacionCaminoAlternativo1 extends javax.swing.JFrame {
     ControladorRecepcionarCotizacion cont;
         public RecepcionarCotizacionCaminoAlternativo1() {
            initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("No existe estado de Reposición Atendida");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecepcionarCotizacionCaminoAlternativo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
