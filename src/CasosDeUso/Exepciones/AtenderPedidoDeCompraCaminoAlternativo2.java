 ...
 * @author Gustavo
 */
public class AtenderPedidoDeCompraCaminoAlternativo2 extends javax.swing.JFrame {
    ControladorAtenderPedidoDeCompra cont;
    /**
     * Creates new form AtenderPedidoDeCompraCaminoAlternativo2
     */
    public AtenderPedidoDeCompraCaminoAlternativo2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("No existe Estado Reposicion con nombre Finalizada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtenderPedidoDeCompraCaminoAlternativo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
