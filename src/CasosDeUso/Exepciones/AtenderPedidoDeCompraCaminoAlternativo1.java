 ...
 * @author Gustavo
 */
public class AtenderPedidoDeCompraCaminoAlternativo1 extends javax.swing.JFrame {
    ControladorAtenderPedidoDeCompra cont;
    /**
     * Creates new form AtenderPedidoDeCompraCaminoAlternativo1
     */
    public AtenderPedidoDeCompraCaminoAlternativo1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("No existe Estado Pedido con nombre Recepcionado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtenderPedidoDeCompraCaminoAlternativo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
