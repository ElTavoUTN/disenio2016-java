 ...
 */
package CasosDeUso.Informes.Excepciones;

import CasosDeUso.Informes.RankearProveedor;
import sistemacompraproveedores.Controladores.ControladorRankearProveedor;


public class RankearProveedorCaminoAlternativo2 extends javax.swing.JFrame {
ControladorRankearProveedor cont;
    
    public RankearProveedorCaminoAlternativo2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("No hay cotizaciones para ninguno de los proveedores habilitados a rankear");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RankearProveedorCaminoAlternativo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
